...
export interface VotingEscrowInterface extends utils.Interface {
  functions: {
    ...
    "setAPI(address)": FunctionFragment;
  ...
  encodeFunctionData(functionFragment: "api", values?: undefined): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "isTransferWhitelisted",
    values: [PromiseOrValue<string>]
  ): string;
  encodeFunctionData(
  ...
  encodeFunctionData(
    functionFragment: "transferWhitelist",
    values: [PromiseOrValue<BigNumberish>]
  ): string;
  encodeFunctionData(
    functionFragment: "transferWhitelistLength",
    values?: undefined
  ): string;
  encodeFunctionData(
  ...
  decodeFunctionResult(functionFragment: "api", data: BytesLike): Result;
  ...
  decodeFunctionResult(functionFragment: "setAPI", data: BytesLike): Result;
  decodeFunctionResult(
    functionFragment: "setApprovalForAll",
    data: BytesLike
  ): Result;
...
export type SetTransferWhitelistEvent = TypedEvent<
  [string, boolean],
  SetTransferWhitelistEventObject
>;

export type SetTransferWhitelistEventFilter =
  TypedEventFilter<SetTransferWhitelistEvent>;
...
export interface VotingEscrow extends BaseContract {
  ...
  functions: {
    ...
    api(overrides?: CallOverrides): Promise<[string]>;
  ...
  filters: {
    ...
    "SetTransferWhitelist(address,bool)"(
      account?: null,
      add?: null
    ): SetTransferWhitelistEventFilter;
  ...
  estimateGas: {
    ...
    api(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    api(overrides?: CallOverrides): Promise<PopulatedTransaction>;

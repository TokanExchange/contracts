...
contract BribeFactory is AccessControl {
    ...
    function init(
        ...
        _grantRole(BRIBE_ADMIN_ROLE, _governor);
        _grantRole(DEFAULT_ADMIN_ROLE, _emergencyCouncil);
        _grantRole(BRIBE_ADMIN_ROLE, _emergencyCouncil);
        voter = _voter;
